...
const testimonials = [
  {
    quote:
      "NirnayAI caught a zero-day payload hidden in a seemingly benign PDF reader that three other enterprise scanners missed entirely.",
    author: "Alex Mercer",
  ...
  {
    quote:
      "The heuristic ML models provide insane accuracy with minimal false positives. It's essentially an automated malware analyst running 24/7.",
    author: "Sarah Chen",
  ...
  {
    quote:
      "Having the dynamic analysis pipeline pipe threat intelligence directly to our WhatsApp group has fundamentally changed our incident response times.",
...
export const Testimonials = () => {
  return (
    <section
      className="relative py-16 sm:py-20 overflow-hidden border-t border-white/5 bg-[#050505]"
      id="testimonials"
    >
      {}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            See what security professionals and malware analysts are saying
            about NirnayAI's threat detection capabilities.
          </motion.p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-auto">
                ...
                <div>
                  ...
                  <p className="text-emerald-500/80 text-xs font-mono">
                    {testimonial.role}
                  </p>
