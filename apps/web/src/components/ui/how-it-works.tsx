...
const steps = [
  {
    ...
    description:
      "Upload your Android APK through our encrypted tunnel. Our system instantly queues it for deep analysis.",
  ...
  },
  {
    ...
    description:
      "The binary is unpacked. We perform static code analysis, manifest mapping, and sandbox execution.",
    glow: "bg-cyan-500/20",
  ...
  },
  {
    ...
    description:
      "Our heuristic engine cross-references zero-days and identifies malicious intent using advanced ML models.",
  ...
  },
  {
    ...
    description:
      "Receive a comprehensive risk report with precise mitigation steps, instantly pushed to your dashboard or via WhatsApp.",
    glow: "bg-red-500/20",
...
export const HowItWorks = () => {
  return (
    <section
      className="relative py-16 sm:py-20 overflow-hidden border-t border-white/5 bg-[#0a0a0e]/40"
      id="how-it-works"
    >
      {}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-24">
          ...
          >
            NirnayAI transforms raw Android binaries into actionable
            intelligence in seconds. Follow the lifecycle of a single APK scan.
          </motion.p>
        </div>
            ...
            {steps.map((step, idx) => (
              ...
              >
                ...
                <div className="relative shrink-0">
                  {}
                  <div
                    className={`absolute inset-0 ${step.glow} rounded-full blur-2xl scale-150 opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>

                  {}
                  <div
                    className={`w-16 h-16 md:w-24 md:h-24 rounded-full border border-white/10 bg-[#050505] flex items-center justify-center relative overflow-hidden ${step.border} transition-colors duration-500 shadow-[0_0_20px_rgba(0,0,0,0.5)] backdrop-blur-xl`}
                  >
                    <step.icon
                      className={`w-7 h-7 md:w-10 md:h-10 text-slate-500 ${step.iconColor} transition-colors duration-500 relative z-10`}
                    />
                ...
                <div className="flex-1 md:text-center mt-1 md:mt-2">
                  <h4 className="text-xl font-semibold text-white mb-3 tracking-tight group-hover:text-emerald-50 transition-colors">
                    {step.title}
                  </h4>
